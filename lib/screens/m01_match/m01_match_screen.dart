...
class M01MatchScreen extends ConsumerWidget {
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  _CirclePhoto(seed: mine.primaryPhotoSeed, label: mine.displayName),
              ...
              const SizedBox(height: AppSpacing.xxl),
              Text(
                GoalCopy.matchBody(goal, mine.displayName, profile.name),
